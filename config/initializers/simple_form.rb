...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.optional :linked_to
    b.optional :stimulus
    b.optional :calculated
    b.optional :data_attributes
    b.use :label
  ...
  config.wrappers :input_group, tag: 'div', class: 'form-group row', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    ...
    b.use :label, class: 'col-sm-3 col-form-label'
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-9' do |ba|
      ba.wrapper :input_group_tag, tag: 'div', class: 'input-group' do |bb|
        bb.optional :prepend
